export const en = {
  ...
  config: {
    ...
    toolCatalog: {
      ...
      capabilities: {
        filesystem: { name: 'Filesystem', description: 'Read, search, create, and modify files in the configured workspace.' },
        shell: { name: 'Shell', description: 'Run bounded commands and control long-running background processes.' },
        web: { name: 'Web', description: 'Search the web, retrieve pages, and interact with browser-based content.' },
        agent: { name: 'Agent', description: 'Plan work, ask questions, render interfaces, and delegate bounded tasks.' },
        creative: { name: 'Creative', description: 'Generate, inspect, speak, or share rich media and social content.' },
        'memory-recall': { name: 'Memory & recall', description: 'Search durable memory and retrieve relevant past sessions.' },
      },
      tools: {
        ReadFileTool: { name: 'Read file', description: 'Read file content from the configured workspace.' },
        WriteFileTool: { name: 'Write file', description: 'Create or overwrite a file with the provided content.' },
        EditFileTool: { name: 'Edit file', description: 'Make exact string replacements in existing files.' },
        GlobTool: { name: 'Find files', description: 'Find files whose paths match a glob pattern.' },
        GrepTool: { name: 'Search files', description: 'Search file contents with a regular expression.' },
        RunCommandTool: { name: 'Run command', description: 'Run a bounded shell command, Python snippet, or Node.js snippet and wait for its complete output.' },
        StartCommandTool: { name: 'Start command', description: 'Start a long-running command in the background and return an ID for later checks or cancellation.' },
        CheckCommandTool: { name: 'Check command', description: 'Read new output and the current status of a command started in the background.' },
        StopCommandTool: { name: 'Stop command', description: 'Stop a background command and clean up its process resources.' },
        BrowsingTool: { name: 'Browser', description: 'Open and interact with browser pages, including navigation, clicks, forms, and screenshots.' },
        WebpageTool: { name: 'Fetch webpage', description: 'Retrieve and extract readable content from a web page.' },
        WebSearchTool: { name: 'Web search', description: 'Search the web through SearXNG or the configured fallback provider.' },
        AskQuestionTool: { name: 'Ask question', description: 'Pause execution to ask the user a focused question when input is required.' },
        GoalTool: { name: 'Manage goal', description: 'Create, inspect, and complete a durable goal that can continue across turns.' },
        TaskCreateTool: { name: 'Create tasks', description: 'Create structured project tasks with dependencies, assignees, and progress metadata.' },
        TaskUpdateTool: { name: 'Update task', description: 'Update the status, ownership, description, or dependencies of an existing task.' },
        TaskListTool: { name: 'List tasks', description: 'List project tasks with their status, ownership, and dependency relationships.' },
        RenderUITool: { name: 'Render UI', description: 'Render an interactive form, table, card, or action panel.' },
        AgentTool: { name: 'Sub-agent', description: 'Delegate a bounded task to a sub-agent in the foreground or background.' },
        ImageGenerationTool: { name: 'Generate image', description: 'Generate an image from a text prompt.' },
        ImageVisionTool: { name: 'Analyze image', description: 'Analyze an image with a vision-capable language model.' },
        SpeakTool: { name: 'Speak', description: 'Convert a response to speech and return playable audio.' },
        SocialMessageTool: { name: 'Social message', description: 'Send a message through a configured social channel after approval.' },
        MemorySearchTool: { name: 'Search memory', description: 'Search long-term archival memory for relevant information.' },
        SessionSearchTool: { name: 'Search sessions', description: 'Search and read relevant past conversation sessions.' },
      },
    },
    memory: {
      label: 'Memory System',
