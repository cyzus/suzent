export const en = {
  ...
  settings: {
    ...
    data: {
      ...
      working: 'Working...',
      exportHint: 'Default output: ~/.suzent/exports/',
      exported: 'Exported to {path}',
      exportFailed: 'Export failed: {error}',
      import: 'Import snapshot',
      importing: 'Importing snapshot...',
      importConfirm: 'Import this snapshot and replace local data? {count} top-level entries will be restored. A backup will be created first.',
      imported: 'Imported into {path}. Previous data was backed up to {backup}',
      importFailed: 'Import failed: {error}',
      statusFailed: 'Could not load data status. The backend may need to be restarted.',
      syncTarget: 'Sync folder',
      syncDesc: 'A sync folder is a shared folder such as iCloud, OneDrive, Dropbox, or a NAS path. Push writes a timestamped backup there; another machine can pull the newest snapshot later.',
      syncPlaceholder: 'Folder path',
      syncPush: 'Push snapshot',
      syncing: 'Pushing snapshot...',
      synced: 'Synced to {path}',
      syncFailed: 'Sync failed: {error}',
      syncPull: 'Pull latest',
      pulling: 'Checking sync folder...',
      pullConfirm: 'Import the newest snapshot from this sync folder? {count} top-level entries will be restored. A backup will be created first.',
      pulled: 'Pulled latest snapshot into {path}. Previous data was backed up to {backup}',
      ...
      githubQuickStartDesc: 'Create a private GitHub repo (default suzent-brain) and connect. Uses gh browser sign-in when available, or a personal access token / GITHUB_TOKEN.',
      ...
      githubQuickStartCreateRepo: 'Create private GitHub repo for me (requires GitHub CLI + gh auth login)',
      githubQuickStartButton: 'Quick start',
      githubQuickStartRunning: 'Setting up GitHub sync...',
      githubQuickStartAuth: 'Opening GitHub sign-in in your browser…',
      ...
      githubGhRequired: 'Install the GitHub CLI (gh) from cli.github.com, then try Quick start again.',
      githubAuthRequired: 'Sign in with a GitHub personal access token (Advanced) or install GitHub CLI (gh). You can also set GITHUB_TOKEN in your environment.',
      githubTokenLabel: 'GitHub personal access token',
      githubTokenPlaceholder: 'ghp_… (repo scope)',
      githubTokenConfigured: 'Token saved — leave blank to keep',
      githubTokenHelp: 'Optional if gh is installed. Create a classic token with repo scope at github.com/settings/tokens, or set GITHUB_TOKEN in your environment.',
      githubTokenHint: 'GitHub CLI not detected by the server (or restart the backend after updating). You can still add a token under Advanced or set GITHUB_TOKEN.',
      ...
      shibbolethTitle: 'Shibboleth (Passphrase)',
      ...
      shibbolethLabel: 'Shibboleth (Passphrase)',
      shibbolethPlaceholder: 'At least 12 characters',
      shibbolethConfirm: 'Confirm Shibboleth',
      shibbolethHint: 'Optional. When enabled, only ciphertext is stored in your Git sync repo — never plaintext API keys or key files.',
      shibbolethWarning: 'If you forget this passphrase, encrypted API keys in GitHub cannot be recovered. Suzent never stores it on disk.',
      shibbolethSetup: 'Set up Shibboleth',
      shibbolethEnable: 'Enable encrypted API sync',
      shibbolethDisable: 'Disable encrypted API sync',
      shibbolethUnlockAction: 'Unlock',
      shibbolethLockAction: 'Lock session',
      shibbolethOn: 'Encrypted sync on',
      shibbolethOff: 'Encrypted sync off',
      shibbolethUnlockedBadge: 'Unlocked',
      shibbolethLockedBadge: 'Locked',
      shibbolethEnabled: 'Shibboleth enabled. Unlock before push or pull to sync API keys.',
      shibbolethDisabled: 'Encrypted API sync disabled.',
      shibbolethUnlocked: 'Shibboleth unlocked for this session.',
      shibbolethLocked: 'Shibboleth locked.',
      shibbolethTooShort: 'Shibboleth must be at least {min} characters.',
      shibbolethMismatch: 'Shibboleth entries do not match.',
      shibbolethHasBundles: 'Encrypted API key bundles are present in the sync repo. Unlock to import them on pull.',
      shibbolethNoBundles: 'No encrypted bundles in the repo yet. Push after unlock to publish ciphertext.',
      shibbolethRequiredForSync: 'Unlock Shibboleth (Passphrase) before push or pull when encrypted API sync is enabled.',
    ...
    roles: {
      ...
      addFromAvailable: 'Add from enabled models',
