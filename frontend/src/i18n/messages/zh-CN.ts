export const zhCN = {
  ...
  settings: {
    browser: {
      ...
      extensionInstall:
        '在 Chrome 或 Edge 的扩展管理页面启用开发者模式，选择加载解压缩的扩展，再选择上方显示的本地扩展文件夹。也可下载 ZIP 并解压到固定位置，然后选择该文件夹。暂未提供商店安装。',
      ...
      persistentHelp: '在 Suzent 专用配置中保留 Cookie 和登录状态。不会导入日常浏览器的登录状态。',
      visible: '显示浏览器窗口',
