export const zhCN = {
  ...
  settings: {
    ...
    browser: {
      ...
      extensionOtherBrowser: '使用其他浏览器？将此私密链接粘贴到该浏览器，5 分钟内有效。',
      ...
      edge: 'Microsoft Edge',
      channelHelp: '运行 Suzent 后端的电脑上必须已安装 Chrome 或 Edge。',
      chromiumHelp: '需要时自动下载；安装需要连接互联网。',
      notInstalled: '未在支持的安装位置找到',
      recheck: '刷新',
      selectedUnavailable: '未找到所选浏览器。请选择 Chromium，或安装该浏览器后重新检查。',
      persistent: '记住浏览器登录状态',
      persistentHelp: '在 Suzent 独立配置中保留登录状态。',
      visible: '显示浏览器窗口',
      visibleHelp: '显示窗口，方便登录或与 Suzent 一起浏览。',
    ...
    providers: {
      ...
      noMatchingProviders: '没有匹配的提供商，请尝试其他名称。',
      searchModels: '按名称或 ID 搜索模型…',
      enabledCount: '已启用 {count} 个模型',
      keySet: '已配置密钥',
      noKey: '需要密钥',
      customProvider: '自定义提供商',
      environmentValue: '环境变量',
      savedValue: '已保存',
      testConnection: '测试连接并获取模型',
      connectionHint: '保存凭据后测试连接，再选择需要启用的模型。',
      connectionSuccess: '连接成功，发现 {count} 个模型。请选择要使用的模型。',
      unsavedCredentials: '请先保存或取消凭据修改，再测试连接。',
      enabledSummary: '已启用 {models} 个模型 · 来自 {providers} 个提供商',
      enabledSummaryHint: '已启用不代表连接已验证。点击模型可前往对应提供商配置。',
      enabledEmpty: '尚未启用模型。展开下方提供商即可开始配置。',
      title: '模型提供商',
    ...
    acp: {
      ...
      setupTitle: '需要安装',
      installGuide: '安装指南',
      installHint: '不同平台的安装方式不同。请按官方指南安装，然后重新打开此页。',
      adapterTitle: '适配器包',
      adapterHint: 'Suzent 通过 npm 适配器启动该智能体。提前安装可避免首条消息卡在下载上。',
      builtIn: '内置',
      custom: '自定义',
      command: '命令',
      activeSessions: '{count} 个活跃',
      savedSessions: '{count} 个已保存',
      noSessions: '无会话',
      authOk: '已认证',
      authUnknown: '认证未知',
      authMissing: '需要认证',
    ...
    service: {
      title: '后台服务',
      subtitle: '关闭窗口后继续运行自动化、消息渠道和后台任务',
      backgroundTitle: '在后台运行 Suzent',
      backgroundDesc: '登录系统后自动启动，并在关闭桌面窗口后保持运行。',
      status: '状态',
      uptime: '运行时间',
      memory: '内存',
      ready: '已就绪',
      ...
      logCopied: '已复制',
      logEmpty: '日志为空。',
      logNoMatch: '没有符合该筛选条件的行。',
      logCounts: '共 {total} 行，显示 {shown} 行',
      logProblems: '{count} 条错误',
    },
    security: {
      title: '安全',
      subtitle: '沙箱与执行隔离设置',
    ...
    roles: {
      title: '模型角色',
      subtitle: '按任务分配模型。未配置的角色继承上级角色，单独配置后覆盖继承。',
      customStatus: '单独配置',
      inheritedStatus: '继承中',
      restoreInheritance: '恢复继承模型',
      overrideCount: '{count} 项单独配置',
      defaultsGroup: '默认模型',
      defaultsGroupDesc: '先设置主要模型。轻量任务继承「轻量」，判断任务共用「决策」。',
      tasksGroup: '后台任务',
      tasksGroupDesc: '标题和记忆提取继承「轻量」，Dream 继承「主要」。按需单独配置即可。',
      specialistsGroup: '专用模型',
      specialistsGroupDesc: '视觉可继承兼容的主要模型，其余能力需要单独配置。',
      modelOrder: '模型按优先级排列，首选模型放在最上方。',
      compactIntro: '点击角色编辑模型。未单独配置的任务会沿用上级模型。',
      fromRole: '继承自{role}',
      chooseModel: '选择模型',
      inheritPreview: '将使用{role}的 {model}。',
      emptyPreview: '尚无可用模型，可在下方添加。',
      applyChanges: '应用更改',
      modelSource: '模型来源',
      inheritMode: '继承上级',
      customMode: '单独指定',
      parentMissing: '上级尚无兼容的模型。请先配置上级，或单独指定模型。',
      clearRole: '清除模型配置',
      backupModels: '备用模型 · {count}（可选）',
      addBackup: '添加备用模型',
      primary: '主要',
      primaryDesc: '主聊天 Agent，需要工具调用和大上下文支持。',
      cheap: '轻量',
      cheapDesc: '轻量任务和决策任务的默认模型。',
      decision: '决策',
      decisionDesc: '目标判断和权限审批共用的模型。',
      autoTitle: '标题',
      autoTitleDesc: '自动生成会话标题。',
      memoryExtraction: '记忆提取',
      memoryExtractionDesc: '从对话中提取需要长期保留的信息。',
      dream: 'Dream',
      dreamDesc: '整合跨对话记忆并巡检知识库。',
      goalJudge: '目标判断',
      goalJudgeDesc: '判断当前目标是否已经完成。',
      permissionReview: '权限审批',
      permissionReviewDesc: '判断工具操作是否可以自动批准。',
      inheritedModels: '继承模型：{models}',
      inheritsCheap: '未配置时依次继承「轻量 → 主要」的模型链。',
      inheritsDecision: '未配置时依次继承「决策 → 轻量 → 主要」的模型链。',
      advancedDecision: '高级决策角色',
      advancedDecisionDesc: '按需覆盖各项决策任务的模型；留空则共用「决策」模型。',
      vision: '视觉',
      ...
      moveDown: '下移（降低优先级）',
      firstChoice: '首选',
      fallbackNumber: '降级 {number}',
      lastResort: '最终备选',
      chainStops: '如果此链中的所有模型都失败，该角色会停止，不会自动切换到其他角色。',
      inheritsPrimary: '此角色为空时，使用「主要」角色的完整模型链。',
      inheritsVisionPrimary: '仅使用「主要」角色中已确认支持视觉的模型；能力未知的模型会被跳过。',
      noImplicitFallback: '没有隐式降级路径；分配模型前，此功能不可用。',
      unverified: '能力未验证',
      explicitOverride: '该模型不在此角色已验证的建议列表中，但仍允许显式分配。',
      unregisteredAvailable: '也可以显式选择能力尚未登记的已启用模型。',
    },
    sandbox: {
      title: '笔记目录',
    ...
    usage: {
      ...
      utcTime: 'UTC 时间',
      tokensLowercase: 'Token',
      activePeriods: '{count} 个活跃时段',
      activityCellLabel: '{date}，{tokens} Token，{calls} 次调用',
      less: '较少',
      more: '较多',
    ...
    automation: {
      ...
      runsIn: '运行于',
      runsInIsolated: '独立会话',
      runsInHint: '绑定到会话后任务能看到并延续这段对话，代价是每次运行都要带上它的历史。',
      quietWhenNothing: '没有要报告的就保持安静',
      heartbeatManagedHint: '由该会话的 Config 标签页管理 —— 请在那里修改心跳设置。',
      summaryOnceUnset: '运行一次（时间未设置）',
      boundTo: '在 {chat} 中',
  ...
  chatInput: {
    ...
    thinkingTitle: '思考',
    thinkingSliderLabel: '思考强度',
    thinkingAutoLabel: '使用默认思考强度',
    thinkingManualLabel: '恢复之前的手动思考强度',
    thinkingModes: {
      auto: '自动',
      manual: '手动',
      off: '关闭',
  ...
  chatWindow: {
    ...
    streamRecoveryUnavailable: '无法恢复此条流。请刷新以读取已保存的对话。',
    streamPersistenceFailed: '回复保存失败，已收到的内容会保留显示。',
    streamInterrupted: '连接中断，请刷新重连；已收到的内容会保留显示。',
    ...
    permissionModeDescriptions: {
      ...
      full_access: '执行工具操作时不请求批准，但显式拒绝规则仍然生效。',
    },
  ...
  status: {
    ...
    backgroundChecking: '正在检查服务',
    backgroundOnline: '服务在线',
    backgroundStarting: '服务启动中',
    backgroundOffline: '服务离线',
  ...
  toolSummary: {
    ...
    verbsActive: {
      ...
      say: '正在朗读',
      sendMessage: '正在发送消息',
      listContacts: '正在查看联系人',
      useSkill: '正在使用技能',
      searchMemory: '正在搜索记忆',
      searchChats: '正在搜索历史对话',
      delegate: '正在委派',
      listAgents: '正在查看代理',
      checkAgent: '正在查看代理',
      messageAgent: '正在通知代理',
    ...
    inScope: '{value}（范围：{scope}）',
    onChannel: '{value}（{channel}）',
    namedAgent: '{type} 代理',
    anyAgent: '子代理',
    repeats: {
      read: '读取了 {count} 个文件',
      ...
      edit: '编辑了 {count} 个文件',
      run: '执行了 {count} 条命令',
      searchWeb: '进行了 {count} 次网络搜索',
      searchCode: '搜索了 {count} 次代码',
      findFiles: '查找了 {count} 次文件',
      openPage: '打开了 {count} 个网页',
      browser: '执行了 {count} 次浏览器操作',
      generic: '{name} · {count} 次',
    },
    /** Same streak, still in flight — the rail says what is happening now. */
    repeatsActive: {
      read: '正在读取 {count} 个文件',
      write: '正在写入 {count} 个文件',
      edit: '正在编辑 {count} 个文件',
      run: '正在执行 {count} 条命令',
      searchWeb: '正在进行 {count} 次网络搜索',
      searchCode: '正在搜索 {count} 次代码',
      findFiles: '正在查找 {count} 次文件',
      openPage: '正在打开 {count} 个网页',
      browser: '正在执行 {count} 次浏览器操作',
      generic: '{name} · {count} 次',
    },
  },
  toolCallBlock: {
    ...
    permissionDecisionTitle: '权限决策',
    permissionOutcome: '结果',
    permissionEvaluator: '评估来源',
    ...
    permissionReason: '原因',
    permissionResolution: '用户处理',
    permissionNotReviewed: '未审核',
    permissionFullAccess: '完全访问 · 未审核',
    permissionUserAllowed: '用户已允许',
    permissionUserDenied: '用户已拒绝',
    permissionReviewRequired: '需要确认',
  ...
  sandbox: {
    ...
    contextMenu: {
      ...
      deleteDirectoryConfirm: '删除“{name}”及其中的所有内容？此操作无法撤销。',
      revealFailed: '无法在文件管理器中显示此项目',
      copyFailed: '无法复制路径',
  ...
  coreMemory: {
    ...
    labels: {
      ...
      context: { title: '上下文', desc: '项目共享上下文' },
    },
  },
  planProgress: {
  ...
  memoryView: {
    ...
    coreMemoryDesc: '始终可见的记忆与非空项目上下文',
    projectContextTitle: '项目上下文',
    projectContextMeta: '{name} · {count} 个会话',
    archivalTitle: '归档数据库',
    archivalDesc: '只读搜索索引',
  ...
  browser: {
    exitControl: '退出控制 (Esc)',
    livePreview: '实时预览',
    stopPreview: '停止预览',
    previewOff: '预览已关闭',
    waitingForStream: '等待预览画面',
    showTab: '显示标签页',
    showTabError: '无法显示浏览器标签页。',
    noSelectedTab: '未选择标签页',
    title: '浏览器',
    navigate: '导航',
    execute: '执行',
