                ...
                >
                  <div className="group-hover:hidden">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" role="img" aria-label="Suzent Logo" className="h-10 w-10">
                      <rect x="3.5" y="3.5" width="17" height="17" rx="3" fill="#000000" stroke="#FFFFFF" strokeWidth="0.4" />
                      <rect x="6.5" y="8" width="3.5" height="3.5" rx="1" fill="#FFFFFF" />
                      <rect x="14" y="8" width="3.5" height="3.5" rx="1" fill="#FFFFFF" />
                    </svg>
                  </div>
