        ...
        <div className="flex-1 flex flex-col overflow-hidden w-full">
          ...
          >
            ...
            >
              ...
              {/* Dark mode toggle. Not in the console: its navigation carries
                  the switch instead, where it is on screen on every route --
                  this header is drawn on chat and nowhere else. */}
              {!isWeb() && (
                <button
                  onClick={toggleTheme}
