...
export const MemoryView: React.FC = () => {
  ...
  const tabs: { id: MemoryTab; label: string }[] = [
    { id: 'overview', label: t('memoryView.tabs.overview') },
    { id: 'daily-logs', label: t('memoryView.tabs.dailyLogs') },
    { id: 'memory-file', label: t('memoryView.tabs.memoryFile') },
    { id: 'transcripts', label: t('memoryView.tabs.transcripts') },
  ];
