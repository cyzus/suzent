...
export function BrutalToggle({
  ...
  label,
  className = '',
}: BrutalToggleProps): React.ReactElement {
  return (
    <button
    ...
    >
      <div
        className={`w-6 h-6 border-3 border-brutal-black flex items-center justify-center ${checked ? 'bg-brutal-black' : 'bg-white dark:bg-zinc-600'}`}
      >
        {checked && (
          <svg
