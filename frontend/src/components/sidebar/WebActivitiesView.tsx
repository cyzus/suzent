  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-zinc-900 w-full min-h-0 relative">
      ...
      <div className="shrink-0 flex items-stretch justify-between bg-white dark:bg-zinc-900 border-b-4 border-brutal-black dark:border-black w-full min-w-0 z-30">
        ...
        >
          <div
            className={`transition-opacity duration-200 ${activeViewId !== 'browser_active' ? 'group-hover:opacity-0' : ''}`}
          >
              ...
              {history.map((item, idx) => {
                ...
                return (
                  ...
                  >
                    {/* Node Mark */}
                    <div
                      className={`absolute -left-[31px] top-1.5 w-3.5 h-3.5 transition-all border-2
                    ...
                    <div
                      className={`flex flex-col gap-1 -mt-1 p-2 -ml-2 rounded-sm transition-all
                        ${
                          isActive
                    ...
                    >
                      <span
                        className={`text-sm md:text-xs font-bold leading-tight font-mono tracking-tight truncate 
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <span
                          className={`text-[10px] font-black uppercase tracking-wider px-1.5 py-0.5 border
