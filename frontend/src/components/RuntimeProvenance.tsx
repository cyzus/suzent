...
export const RuntimeProvenance: React.FC<Props> = ({ config, compact = false }) => {
  ...
  return (
    <div className="border-2 border-black p-2 bg-white flex flex-col gap-1 w-fit">
      {isAcp ? (
        <>
          <div className="font-mono text-xs font-bold uppercase bg-black text-white px-1">EXTERNAL RUNTIME</div>
          ...
          <div className="text-[10px] font-mono border-t border-black pt-1">SUZENT NATIVE MODEL BYPASSED</div>
        </>
      ) : (
        <>
          <div className="font-mono text-xs font-bold uppercase border-b border-black">SUZENT RUNTIME</div>
