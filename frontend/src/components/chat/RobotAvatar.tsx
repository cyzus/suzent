...
export const RobotAvatar: React.FC<RobotAvatarProps> = ({ variant = 'idle', className = '' }) => {
  ...
  const RobotBody = ({
    ...
    <div className="w-full h-full flex items-center justify-center" style={style}>
      <svg
        ...
        viewBox="0 0 24 24"
        style={{ transform: `scale(${ROBOT_SCALE})` }}
      >
        {children}
      </svg>
    </div>
      ...
      <div className={`relative w-full h-full ${className}`}>
        ...
        >
          ...
          >
            <RobotFace
              eyeStyle={{
                animation: 'robot-breathe-eyes 4s infinite ease-in-out',
            ...
            <text
              ...
              fill="#000000"
              opacity="0.6"
              style={{ animation: 'robot-float-z 3s infinite linear' }}
            >
              Z
            </text>
            <text
              ...
              fill="#000000"
              opacity="0.6"
              style={{ animation: 'robot-float-z 3s infinite linear', animationDelay: '1s' }}
            >
              z
            </text>
            <text
              ...
              fill="#000000"
              opacity="0.6"
              style={{ animation: 'robot-float-z 3s infinite linear', animationDelay: '2s' }}
            >
              .
            </text>
          </svg>
  ...
  if (variant === 'peeker') {
    return (
      <div className={`relative w-full h-full overflow-hidden ${className}`}>
        <BaseRobot
          style={{
            animation: 'robot-peek-up 3s infinite ease-in-out',
      ...
      <div className={`relative w-full h-full ${className}`}>
        ...
        >
          ...
          >
            <RobotFace
              eyeStyle={{
                animation: 'robot-dilate 2s infinite alternate',
                transformOrigin: 'center',
              }}
            />
            ...
            <ellipse
              ...
              opacity="0"
              style={{
                animation: 'robot-sweat-drop 0.8s infinite',
                transformOrigin: 'center',
            ...
            <ellipse
              ...
              opacity="0"
              style={{
                animation: 'robot-sweat-drop 0.7s infinite 0.2s',
                transformOrigin: 'center',
                transformBox: 'fill-box',
              }}
            />
            <ellipse
              ...
              opacity="0"
              style={{
                animation: 'robot-sweat-drop 0.8s infinite 0.4s',
                transformOrigin: 'center',
                transformBox: 'fill-box',
              }}
            />
            <ellipse
              ...
              opacity="0"
              style={{
                animation: 'robot-sweat-drop 0.7s infinite 0.1s',
                transformOrigin: 'center',
                transformBox: 'fill-box',
              }}
            />
    ...
    return (
      <div className={`relative w-full h-full ${className}`}>
        <div
          className="w-full h-full flex items-center justify-center"
          style={{
            animation: 'robot-ponder-tilt 3s infinite ease-in-out',
            transformOrigin: 'bottom center',
          }}
        >
          <svg
          ...
          >
            ...
            <rect
              ...
              style={{
                transformOrigin: 'center',
                animation: 'robot-squint 3s infinite ease-in-out',
              }}
            />
            <rect
              className="eye"
              ...
              rx="1.5"
              fill="#FFFFFF"
              style={{ animation: 'robot-raise-brow 3s infinite ease-in-out' }}
            />
            {/* Floating ? - SVG text */}
            <text
              x="22"
              ...
              fontWeight="bold"
              fill="#000000"
              style={{ animation: 'robot-float-q 3s infinite ease-in-out' }}
            >
              ?
            </text>
          </svg>
  ...
  if (variant === 'love') {
    return (
      <div className={`relative w-full h-full ${className}`}>
        <div
          className="w-full h-full flex items-center justify-center"
          style={{ animation: 'robot-heartbeat 1s infinite' }}
        >
          <svg
            className="w-full h-full"
            viewBox="0 0 24 24"
          ...
          >
            ...
            <text
              ...
              fill="#FFFFFF"
              style={{
                animation: 'robot-pulse-eye 1s infinite alternate',
                transformOrigin: 'center',
              }}
            >
              ♥
            ...
            <text
              ...
              fontSize="4"
              fill="#000000"
              style={{ animation: 'robot-float-up 2s infinite linear' }}
            >
              ♥
            </text>
            <text
              ...
              fontSize="3"
              fill="#000000"
              style={{ animation: 'robot-float-up 2s infinite linear 0.5s' }}
            >
              ♥
            </text>
            <text
              ...
              fontSize="4"
              fill="#000000"
              style={{ animation: 'robot-float-up 2s infinite linear 1s' }}
            >
              ♥
            </text>
            <text
              ...
              fontSize="3"
              fill="#000000"
              style={{ animation: 'robot-float-up 2s infinite linear 1.5s' }}
            >
              ♥
            </text>
          </svg>
  ...
  if (variant === 'rage') {
    return (
      <div className={`relative w-full h-full ${className}`}>
        <div
          className="w-full h-full flex items-center justify-center"
          style={{ animation: 'robot-seethe 2s infinite ease-in-out' }}
        >
          <svg
            className="w-full h-full"
            viewBox="0 0 24 24"
          ...
          >
            ...
            <circle
              ...
              fill="#666666"
              opacity="0"
              style={{ animation: 'robot-steam-rise 0.5s infinite linear' }}
            />
            <circle
              cx="26"
              cy="4"
              ...
              fill="#666666"
              opacity="0"
              style={{ animation: 'robot-steam-rise 0.5s infinite linear 0.2s' }}
            />
          </svg>
        </div>
      </div>
      ...
      <div className={`relative w-full h-full ${className}`}>
        <div className="w-full h-full flex items-center justify-center">
          ...
          >
            ...
            <g
              style={{
                animation: 'robot-eat-top 1.5s infinite ease-in-out',
                transformOrigin: '4px 15px',
              }}
            >
            ...
            <g
              style={{
                animation: 'robot-eat-bottom 1.5s infinite ease-in-out',
                transformOrigin: '4px 15px',
              }}
            >
            ...
            <g style={{ transform: 'translateY(15px)' }}>
              ...
              <g
                style={{
                  animation: 'robot-feed-train 12s infinite linear',
                  animationDelay: '0s',
                  opacity: 0,
                }}
              >
                <text x="0" y="2" fontSize="6" fontWeight="bold" fill="#000000">
                  0
                </text>
                <text x="5" y="2" fontSize="6" fontWeight="bold" fill="#000000">
                  0
                </text>
                <text x="10" y="2" fontSize="6" fontWeight="bold" fill="#000000">
                  0
                </text>
              </g>
              {/* Bite 2: 0 */}
              ...
              >
                <text x="6" y="2" fontSize="6" fontWeight="bold" fill="#000000">
                  0
                </text>
              </g>
              {/* Bite 3: 01 */}
              ...
              >
                <text x="3" y="2" fontSize="6" fontWeight="bold" fill="#000000">
                  0
                </text>
                <text x="8" y="2" fontSize="6" fontWeight="bold" fill="#000000">
                  1
                </text>
              </g>
              {/* Bite 4: 00 */}
  ...
  if (variant === 'dj') {
    return (
      <div className={`relative w-full h-full ${className}`}>
        <div
          className="w-full h-full flex items-center justify-center"
          style={{ animation: 'robot-head-bop 0.5s infinite alternate ease-in-out' }}
        >
          <svg
            className="w-full h-full"
            viewBox="0 0 24 24"
          ...
          >
            {/* Headphones Band */}
            <path
              d="M-2,12 L-2,8 Q-2,-4 12,-4 Q26,-4 26,8 L26,12"
              fill="none"
              stroke="#262626"
              strokeWidth="3"
              strokeLinecap="round"
  ...
  if (variant === 'ghost') {
    return (
      <div className={`relative w-full h-full ${className}`}>
        <div
          className="w-full h-full flex items-center justify-center"
          style={{ animation: 'robot-float-ghost 3s infinite ease-in-out' }}
        >
          <svg
            className="w-full h-full"
            viewBox="0 0 24 24"
          ...
          >
            <path
              d="M2,25 L0,23 L0,13 A12,12 0 0,1 24,13 L24,23 L22,25 L18,21 L14,25 L12,23 L10,25 L6,21 L2,25 Z"
              fill="#000000"
            />
            ...
            <text
              ...
              fontWeight="bold"
              fill="#999999"
              style={{ animation: 'robot-boo-fade 2s infinite' }}
            >
              404
            </text>
          </svg>
    ...
    return (
      <div className={`relative w-full h-full ${className}`}>
        <div
          className="w-full h-full flex items-center justify-center"
          style={{
            animation: 'robot-squat 1.8s infinite ease-in-out',
            transformOrigin: 'bottom center',
          }}
        >
          <svg
          ...
          >
            ...
            <g style={{ animation: 'robot-lift-svg 1.8s infinite ease-in-out' }}>
              ...
              <g
                style={{
                  animation: 'robot-arm-left 1.8s infinite ease-in-out',
              ...
              <g
                style={{
                  animation: 'robot-arm-right 1.8s infinite ease-in-out',
                  transformOrigin: '26px 5px',
                }}
              >
            ...
            <ellipse
              ...
              fill="#666666"
              opacity="0"
              style={{ animation: 'robot-sweat-fall 1.8s infinite' }}
            />
          </svg>
        </div>
      </div>
        ...
        <div className="w-full h-full flex items-center justify-center">
          ...
          >
            ...
            <ellipse
              ...
              ry="3"
              fill="#000000"
              style={{ animation: 'robot-hole-top 2s infinite ease-in-out' }}
            />
            ...
            <ellipse
              ...
              ry="3"
              fill="#000000"
              style={{ animation: 'robot-hole-bottom 2s infinite ease-in-out' }}
            />
          </svg>
        </div>
      </div>
    ...
    return (
      <div className={`relative w-full h-full ${className}`} style={{ perspective: '150px' }}>
        ...
        <div
          ...
          style={{ transform: 'rotateX(45deg)', transformOrigin: 'center' }}
        >
