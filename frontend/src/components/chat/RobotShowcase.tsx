      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {variants.map((variant) => (
            <div
              key={variant}
              className="bg-white border-3 border-brutal-black shadow-brutal-lg p-6 flex flex-col items-center gap-4 transition-transform hover:translate-y-[-4px] hover:shadow-brutal-xl"
            >
