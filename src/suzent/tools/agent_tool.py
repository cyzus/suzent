...
class AgentTool(Tool):
    ...
    session_guidance: str = (
        ...
        "Use agent_list for a bounded status overview, agent_read for the visible child "
        "transcript, and agent_stop to cancel work that is no longer needed. Background "
        "results wake this conversation automatically.\n"
        "\n"
        "### Tool selection\n"
