...
class AgentTool(Tool):
    ...
    session_guidance: str = (
        ...
        "Use agent_list for a bounded status overview, agent_wait when progress depends on a "
        "background result, agent_read for the visible child transcript, and agent_stop to cancel "
