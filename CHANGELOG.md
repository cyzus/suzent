...
### 🐛 Fixed
- Hide Windows service autostart terminal (#109)
...
### 🐛 Fixed
- Make device mesh reliably reachable
...
### 🐛 Fixed
- Stabilize updater progress and headless fallback (#95)
...
### 🐛 Fixed
- Always detach Windows self-updates (#88)
...
### 🐛 Fixed
- Make Windows startup and updates resilient (#83)

## [v0.7.4] - 2026-08-02

### 🚀 Added
- Add fileChipTone prop to ClickableContent for customizable styling

### 🐛 Fixed
- Prevent desktop startup from hanging (#81)
- Correct localized concept links
...
### 🚀 Added
- **Secure Peer Mesh**: Added node auth, LAN discovery, durable device tokens, control grants, peer/device management, and agent-to-agent triggering.
...
- **Runtime**: Reused already-running Suzent servers from the CLI and improved shell/streaming cleanup behavior.
